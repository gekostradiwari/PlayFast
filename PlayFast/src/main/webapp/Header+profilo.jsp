...
<header data-bs-theme="dark">
			...
			<div class="row">
				...
				<div class="col-sm-4 offset-md-1 py-4">
					<button type="button"
						...
						<svg class="bi me-2 opacity-0 theme-icon" width="1em" height="1em">
                ...
                <use href="#check2"></use>
					...
					<button type="button"
						class="dropdown-item d-flex align-items-center"
						data-bs-theme-value="dark2" aria-pressed="false">
	...
	<div class="navbar navbar-dark bg-dark shadow-sm">
		<div class="container">
			<a href="#" class="navbar-brand d-flex align-items-center"> <img
				src="./IMG/logo1.png" alt="Logo" class="logo-img"> <strong>PLAY
					FAST</strong>
			</a>
	...
	<script src="./SCRIPT/Header+profilo.js"></script>
