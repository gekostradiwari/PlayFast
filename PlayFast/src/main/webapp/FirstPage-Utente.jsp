        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <p class="lead text-body-secondary">Sempre a portata di mano e vicino a te.</p>
                </div>
            </div>
        </section>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                                ...
                                <image href="./IMG/ludi-15-1.jpg" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" />
                            </svg>
                            <div class="card-body">
                                <p class="card-text">Il centro sportivo Ludi nasce nel Giugno del 1997 da un’idea di Ernesto che aveva il sogno di creare un centro di aggregazione, divertimento e socializzazione per la comunità Terzignese e non solo.</p>
